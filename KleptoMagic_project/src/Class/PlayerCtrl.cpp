...
void PlayerCtrl::update() {
	...
	if (NewInputHandler::Instance()->isActionPressed(Action::MOVE_RIGHT)) {
		movementVector = { 1, 0 };
	}
	else if (NewInputHandler::Instance()->isActionPressed(Action::MOVE_LEFT)) {
		movementVector = { -1, 0 };
	}
	else if (NewInputHandler::Instance()->isActionPressed(Action::MOVE_UP)) {
		movementVector = { 0, -1 };
	}
	else if (NewInputHandler::Instance()->isActionPressed(Action::MOVE_DOWN)) {
		movementVector = { 0, 1 };
	}
